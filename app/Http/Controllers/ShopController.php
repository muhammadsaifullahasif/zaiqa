...
class ShopController extends Controller
{
    ...
    public function deal(Request $request) 
    {
        ...
        $products->whereHas('variations', function($q) {
            $q->whereHas('product_meta', function($metaQuery) {
                $metaQuery->where('meta_key', 'sale_price')
                    ->where('meta_value', '>', 0)
                    ->where('meta_value', '!=', '');
            });
        });
        ...
        return view('deal', compact('products', 'size', 'orderBy', 'categories', 'units', 'minPrice', 'maxPrice', 'filter_category', 'min_price', 'max_price'));
    }
