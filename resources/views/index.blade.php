                ...
                <div class="container">
                    <div class="row px-lg-5 px-md-3 align-items-center">
                        <div class="col-lg-6 col-md-12">
                            <h1 class="heading dual-heading"><span class="text-secondary">Royal That Speaks</span> <span class="text-white fst-italic">Your Language</span></h1>
                            <p class="text text-white">Some tastes don’t need translation. Whether you’re from Karachi or California, Royal speaks straight to the soul. We bring the familiar flavors you grew up with — spiced just right, cooked with heart, and served with that unmistakable desi warmth.</p>
                            <div class="cta mb-5">
