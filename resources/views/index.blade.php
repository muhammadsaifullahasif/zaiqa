...
<body>
    ...
    {{-- MAIN SECTION START --}}
    <main class="main">
        <header class="header header-desktop header-primary py-3">
            <div class="container">
        ...
        <header class="header header-mobile header-primary">
            <div class="container">
                ...
                <div class="container">
                    <div class="row px-lg-5 px-md-3 align-items-center">
                        <div class="col-lg-6 col-md-12">
                            ...
                            @endforeach
                            {{-- <h1 class="heading dual-heading slider-title active">
                                <span class="text-secondary tagline">Royal That Speaks</span> 
                                <span class="text-white fst-italic title">Your Language</span>
                            </h1> --}}
                            {{-- <p class="text text-white subtitle">Some tastes don’t need translation. Whether you’re from Karachi or California, Royal speaks straight to the soul. We bring the familiar flavors you grew up with — spiced just right, cooked with heart, and served with that unmistakable desi warmth.</p> --}}
                            <div class="cta mb-5">
                        ...
                        <div class="col-lg-6 col-md-12 hero-img-container text-end">
                            ...
                            @endforeach
                            {{-- <img src="{{ asset('assets/images/hero-img.png') }}" class="hero-img" alt=""> --}}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div class="sa-carousel-wrapper mb-3">
                        <div class="sa-carousel-track px-lg-5 px-md-3" id="saCarouselTrack">
                            ...
                            {{-- <div class="sa-carousel-item">
                                <div class="sa-item-card">
                                    <img src="{{ asset('assets/images/kitchen-king.png') }}" alt="Kitchen King" class="sa-item-image">
                                    <span class="sa-item-label">Kitchen King</span>
                                </div>
                            </div>
                            <div class="sa-carousel-item">
                                <div class="sa-item-card">
                                    <img src="{{ asset('assets/images/flame-and-flavor.png') }}" alt="Flame & Flavor" class="sa-item-image">
                                    <span class="sa-item-label">Flame & Flavor</span>
                                </div>
                            </div>
                            <div class="sa-carousel-item">
                                <div class="sa-item-card">
                                    <img src="{{ asset('assets/images/zest-of-royal.png') }}" alt="Zest of Royal" class="sa-item-image">
                                    <span class="sa-item-label">Zest of Royal</span>
                                </div>
                            </div>
                            <div class="sa-carousel-item">
                                <div class="sa-item-card">
                                    <img src="{{ asset('assets/images/sizzle-and-spice.png') }}" alt="Sizzle & Spice" class="sa-item-image">
                                    <span class="sa-item-label">Sizzle & Spice</span>
                                </div>
                            </div>
                            <div class="sa-carousel-item">
                                <div class="sa-item-card">
                                    <img src="{{ asset('assets/images/bbq-grill-mix.png') }}" alt="BBQ Grill Mix" class="sa-item-image">
                                    <span class="sa-item-label">BBQ Grill Mix</span>
                                </div>
                            </div>
                            <div class="sa-carousel-item">
                                <div class="sa-item-card">
                                    <img src="{{ asset('assets/images/qorma-delight.png') }}" alt="Qorma Delight" class="sa-item-image">
                                    <span class="sa-item-label">Qorma Delight</span>
                                </div>
                            </div>
                            <div class="sa-carousel-item">
                                <div class="sa-item-card">
                                    <img src="{{ asset('assets/images/royal-karahi.png') }}" alt="Royal Karahi" class="sa-item-image">
                                    <span class="sa-item-label">Royal Karahi</span>
                                </div>
                            </div>
                            <div class="sa-carousel-item">
                                <div class="sa-item-card">
                                    <img src="{{ asset('assets/images/handi-masala.png') }}" alt="Handi Masala" class="sa-item-image">
                                    <span class="sa-item-label">Handi Masala</span>
                                </div>
                            </div> --}}
                ...
                <div class="container py-5">
                    ...
                    <div class="row px-lg-5 px-md-3 mb-lg-5 mb-md-3 justify-content-between">
                        ...
                        <div class="col-lg-3 col-md-4 about-img-container text-md-center">
                            {{-- <img src="{{ asset('assets/images/about-bg.png') }}" class="about-img about-img-bg" alt=""> --}}
                            {{-- <img src="{{ asset('assets/images/logo-dark.svg') }}" class="about-img" alt=""> --}}
