...
<body>
    ...
    <main class="main">
        ...
        <section class="main-content">
                        ...
                        <div class="col-lg-8 mb-3">
                            ...
                            <div class="delivery-address active mb-5" id="delivery">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select name="delivery-time-slot" id="delivery-time-slot" class="form-control form-control-lg">
                        ...
                        <div class="col-lg-4 mb-3">
                            <div class="checkout-summary card rounded-4 bg-primary">
                                ...
                                <div class="card-footer">
                                    <a href="#" class="btn btn-secondary w-100">Place Order</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal fade show order-successfull" id="order-successfull-modal">
                        ...
                        <div class="modal-body text-center rounded-5 bg-accent">
                            ...
                            <div class="order-detail rounded-3 p-3 mb-3">
                                <p class="d-flex justify-content-between align-item-center">
                                    ...
                                    <strong>#12345 <i class="fas fa-copy text-secondary"></i></strong>
                                </p>
                                <p class="d-flex justify-content-between align-item-center">
