...
<body>
    ...
    <main class="main">
        ...
        <section class="main-content">
                ...
                <div class="container">
                    <div class="row mb-3">
                        <div class="col-12 text-center">
                            <img src="{{ asset('images/avatar/user-1.png') }}" class="mb-2" style="height: 120px; width: 120px;" alt="">
                            <h4 class="fw-semibold">Hella Den H</h4>
                        </div>
                    </div>
                    <div class="dashboard-account-info rounded-4 p-4 mb-3">
                        <h4 class="text-secondary">Contact Info</h4>
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <p class="d-flex justify-content-between align-items-center">
                                    <span>Full Name:</span>
                                    <strong>Hella Den H</strong>
                                </p>
                            </div>
                            <div class="col-lg-4">
                                <p class="d-flex justify-content-between align-items-cenetr">
                                    <span>Phone Number:</span>
                                    <strong>+49 (1726) 086-408</strong>
                                </p>
                            </div>
                            <div class="col-lg-4">
                                <p class="d-flex justify-content-between align-items-center">
                                    <span>Email:</span>
                                    <strong>info@royal-in.com</strong>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-4">
                                <p class="d-flex justify-content-between align-items-center">
                                    <span>Address:</span>
                                    <strong>Address | B.d Schleifmuhle 34, 85049 Ingolstadt</strong>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="dashboard-account-info-edit mb-3">
                        <div class="row">
            ...
            {{-- ORDERS START --}}
            <div class="orders-wrapper py-lg-5 py-md-3">
                <div class="container">
                    <div class="row">
