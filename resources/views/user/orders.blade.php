...
<body>
    ...
    <main class="main">
        ...
        <section class="main-content">
            {{-- ORDERS HEADER START --}}
            <div class="order-header py-lg-5 py-md-3">
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h2 class="dual-heading">
                                <span>Order</span>
                                <span class="text-secondary fst-italic">History</span>
                            </h2>
                            <p>View all your past orders in one place. Reorder your favorites or track recent deliveries with ease.</p>
                        </div>
                    </div>
                </div>
            </div>
